...
test("renders the summary test passed as prop", () => {
    ...
    expect(summary).toHaveTextContent(/A young boy mysteriously disappears, and his panicked mother demands that the police find him. Meanwhile, the boy's friends conduct their own search, and meet a mysterious girl in the forest./i)
});

test("renders default image when image is not defined", () => {
    render(<Episode episode={exampleEpisodeWithoutImageData}/>)
...
const exampleEpisodeWithoutImageData = {
    airdate: "2016-07-15",
    airstamp: "2016-07-15T12:00:00+00:00",
    airtime: "",
    id: 553946,
